...
\renewcommand*{\glstextformat}[1]{\textcolor{violet2}{#1}}
...
\DTMsavedate{end_date}{2024-09-03}
...
{\textcolor{olive2}{Series \thechapter:}}
{1em}
{\textcolor{olive2}}
...
\titlespacing{\section}{1em}{4em}{4em}[1em]
...
% does not support multiline paragraph titles
...
% Which glossaries to be used
\makeglossaries
\loadglsentries{characters}

%%------------------------------------------ CHANGE FONT -----------------------------------------%%

\usepackage[proportional, default, light, semibold, scale=1]{sourceserifpro}
...
\markboth{\sffamily \footnotesize #1}{}}
...
\fancyhead[L]{\sffamily \footnotesize Discworld}
...
% every file is a series, with input commands for each novel inside it
\includeonly{content/rincewind}
...
\include{content/death}
\include{content/industrial_revolution}
\include{content/ancient_civilizations}
\include{content/witches}
\include{content/young_adult}
\include{content/science}


% visual style for the glossaries
